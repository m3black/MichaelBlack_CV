...
%---------------------------------------------------------
  \cventry
    {Analyst / Software Developer} % Job title
    {WSP Canada (Digital Operations, Transportation and Infrastructure)} % Organization
    {Montreal, Quebec} % Location
    {Dec. 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Development of the corporate Digital Operations Center (DOC) using C\# (Windows Forms)}
 \begin{itemize}
        \item {The first in-house software developed by WSP in North America, to be used by all designers on large rail projects}
        \item {Ensures all software (Civil 3D, OpenRoads etc.) is installed and configured correctly for the project requirements}
        \item {Mitigates data corruption caused by designers potentially working with non-approved project software (ie. incorrrect version of Civil 3D)}
        \item {Centralizes all WSP resources to increase User day-to-day working efficiency}
        \item {The DOC is also used to roll out all Digital Operations department updates for teams across Canada}
    \end{itemize}
